...
public class SEOExtensionUtils {
  ...
  public static final String getTitlePage(Channel channel, String defaultTitlePage){
    ...
    if(Util.notEmpty(obj) && obj instanceof Publication){
      ...
      if (Util.notEmpty(pub.getExtraData("extradb.Content.jcmsplugin.seo.titreseo." + channel.getCurrentUserLang()))) {
          return pub.getExtraData("extradb.Content.jcmsplugin.seo.titreseo." + channel.getCurrentUserLang()) + " - " + channel.getName();
      }
